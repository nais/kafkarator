...
func (_m *MockInterface) Create(ctx context.Context, project string, service string, req aiven.CreateKafkaACLRequest) (*aiven.KafkaACL, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string, aiven.CreateKafkaACLRequest) (*aiven.KafkaACL, error)); ok {
		return rf(ctx, project, service, req)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string, aiven.CreateKafkaACLRequest) *aiven.KafkaACL); ok {
	...
	if rf, ok := ret.Get(1).(func(context.Context, string, string, aiven.CreateKafkaACLRequest) error); ok {
...
func (_m *MockInterface) List(ctx context.Context, project string, serviceName string) ([]*aiven.KafkaACL, error) {
	...
	var r0 []*aiven.KafkaACL
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string, string) ([]*aiven.KafkaACL, error)); ok {
		return rf(ctx, project, serviceName)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string, string) []*aiven.KafkaACL); ok {
