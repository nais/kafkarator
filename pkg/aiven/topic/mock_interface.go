...
func (_m *MockInterface) Get(project string, service string, topic string) (*aiven.KafkaTopic, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string, string) (*aiven.KafkaTopic, error)); ok {
		return rf(project, service, topic)
	}
...
func (_m *MockInterface) List(project string, service string) ([]*aiven.KafkaListTopic, error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(string, string) ([]*aiven.KafkaListTopic, error)); ok {
